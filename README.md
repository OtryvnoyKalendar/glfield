...
Для тех, кто не хочет заморачиваться с компиляцией: готовые исполняемые файлы лежат в папке `bin`. Из-за новой версии `SFML`, `OpenGl` на `Linux` может отображаться неправильно.  
